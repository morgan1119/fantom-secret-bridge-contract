 ...
 */
contract StandardToken is ERC20Pausable, ERC20Burnable, Ownable {
    ...
    constructor(string memory symbol, string memory name) ERC20(symbol, name) public {}
    /*
...
contract BlackList is StandardToken {
    constructor(string memory symbol, string memory name) StandardToken(symbol, name) public {}
    ...
    function destroyBlackFunds (address _blackListedUser) public onlyOwner {
        ...
        burnFrom(_blackListedUser, balanceOf(_blackListedUser));
...
contract FHM is BlackList {
    ...
    constructor(uint _initialSupply, string memory _name, string memory _symbol) BlackList(_symbol, _name) public {
